...
CREATE TABLE `auth_list`  (
  ...
  `auth_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '权限名称_c_ss',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `api_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'api路径_c_ss',
  `classify` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '权限分类',
  PRIMARY KEY (`auth_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of auth_list
-- ----------------------------
INSERT INTO `auth_list` VALUES ('accessAppList.add', '添加APP', '2024-09-25 22:34:20', 'accessAppList/add', 'APP管理');
INSERT INTO `auth_list` VALUES ('accessAppList.delete', '删除APP', '2024-09-25 22:34:20', 'accessAppList/delete', 'APP管理');
INSERT INTO `auth_list` VALUES ('accessAppList.search', '查询APP', '2024-09-25 22:34:20', 'accessAppList/search', 'APP管理');
INSERT INTO `auth_list` VALUES ('accessAppList.update', '修改APP', '2024-09-25 22:34:20', 'accessAppList/update', 'APP管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.abmClose', 'ABM解绑', '2024-09-25 22:34:20', 'deviceInfo/abmClose', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.allotDevice', '分配设备', '2024-09-25 22:34:20', 'deviceInfo/allotDevice', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.clearPasscode', '清除锁屏密码', '2024-09-25 22:34:20', 'deviceInfo/clearPasscode', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.controlClose', '一键删除监管', '2024-09-25 22:34:20', 'deviceInfo/controlClose', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.deviceActivateLockClose', '关闭激活锁', '2024-09-25 22:34:20', 'deviceInfo/deviceActivateLockClose', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.deviceActivateLockOpen', '开启激活锁', '2024-09-25 22:34:20', 'deviceInfo/deviceActivateLockOpen', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.disableLostMode', '关闭丢失模式', '2024-09-25 22:34:20', 'deviceInfo/disableLostMode', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.enableLostMode', '启用丢失模式', '2024-09-25 22:34:20', 'deviceInfo/enableLostMode', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.enableTimeLostMode', '启用定时丢失模式', '2024-09-25 22:34:20', 'deviceInfo/enableTimeLostMode', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.eraseDevice', '抹除设备', '2024-09-25 22:34:20', 'deviceInfo/eraseDevice', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.exportDevice', '导出设备', '2024-09-25 22:34:20', 'deviceInfo/exportDevice', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.getActivationLockSkipCode', '获取激活密码', '2024-09-25 22:34:20', 'deviceInfo/getActivationLockSkipCode', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.getDeviceInfo', '获取设备信息', '2024-09-25 22:34:20', 'deviceInfo/getDeviceInfo', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.getHomeInfo', '获取主页统计', '2024-09-25 22:34:20', 'deviceInfo/getHomeInfo', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.getLocation', '获取定位', '2024-09-25 22:34:20', 'deviceInfo/getLocation', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.lockMsgUpdate', '修改锁屏消息', '2024-09-25 22:34:20', 'deviceInfo/lockMsgUpdate', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.removeMobileFile', '删除监管文件', '2024-09-25 22:34:20', 'deviceInfo/removeMobileFile', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.resetAuth', '重置为最新安全策略', '2024-09-25 22:34:20', 'deviceInfo/resetAuth', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.search', '搜索设备', '2024-09-25 22:34:20', 'deviceInfo/search', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.setWp', '设置壁纸', '2024-09-25 22:34:20', 'deviceInfo/setWp', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.updateAccessAppAuth', '修改APP访问限制', '2024-09-25 22:34:20', 'deviceInfo/updateAccessAppAuth', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.updateAccessAuth', '修改设备访问限制', '2024-09-25 22:34:20', 'deviceInfo/updateAccessAuth', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.updateDevice', '更新设备', '2024-09-25 22:34:20', 'deviceInfo/updateDevice', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.updateDeviceInfo', '修改设备信息', '2024-09-25 22:34:20', 'deviceInfo/updateDeviceInfo', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfo.updateIos', '强制更新系统', '2024-09-25 22:34:20', 'deviceInfo/updateIos', '设备管理');
INSERT INTO `auth_list` VALUES ('deviceInfos.deviceActivateLockClose', '关闭激活锁', '2024-09-25 22:34:20', 'deviceInfos/deviceActivateLockClose', '设备批量管理');
INSERT INTO `auth_list` VALUES ('deviceInfos.deviceActivateLockOpen', '开启激活锁', '2024-09-25 22:34:20', 'deviceInfos/deviceActivateLockOpen', '设备批量管理');
INSERT INTO `auth_list` VALUES ('deviceInfos.disableLostMode', '关闭丢失模式', '2024-09-25 22:34:20', 'deviceInfos/disableLostMode', '设备批量管理');
INSERT INTO `auth_list` VALUES ('deviceInfos.enableLostMode', '启用丢失模式', '2024-09-25 22:34:20', 'deviceInfos/enableLostMode', '设备批量管理');
INSERT INTO `auth_list` VALUES ('deviceInfos.resetAuth', '重置为最新安全策略', '2024-09-25 22:34:20', 'deviceInfos/resetAuth', '设备批量管理');
INSERT INTO `auth_list` VALUES ('deviceInfos.updateDevice', '更新设备', '2024-09-25 22:34:20', 'deviceInfos/updateDevice', '设备批量管理');
INSERT INTO `auth_list` VALUES ('deviceInfos.updateIos', '强制更新系统', '2024-09-25 22:34:20', 'deviceInfos/updateIos', '设备批量管理');
INSERT INTO `auth_list` VALUES ('group.addGroup', '添加分组', '2024-09-26 16:02:34', 'group/search', '设备分组');
INSERT INTO `auth_list` VALUES ('group.deleteGroup', '删除分组', '2024-09-26 16:02:34', 'group/deleteGroup', '设备分组');
INSERT INTO `auth_list` VALUES ('group.getMyGroupList', '获取自己分组', '2024-09-26 16:02:34', 'group/getMyGroupList', '设备分组');
INSERT INTO `auth_list` VALUES ('group.search', '设备分组搜索', '2024-09-26 16:02:34', 'group/search', '设备分组');
INSERT INTO `auth_list` VALUES ('group.updateGroup', '修改分组', '2024-09-26 16:02:34', 'group/updateGroup', '设备分组');
INSERT INTO `auth_list` VALUES ('lostMsgList.addLost', '丢失消息添加', '2024-09-25 22:34:20', 'lostMsgList/addLost', '丢失消息管理');
INSERT INTO `auth_list` VALUES ('lostMsgList.deleteLost', '丢失消息删除', '2024-09-25 22:34:20', 'lostMsgList/deleteLost', '丢失消息管理');
INSERT INTO `auth_list` VALUES ('lostMsgList.getMyLostList', '获取自己的所有丢失消息', '2024-09-25 22:34:20', 'lostMsgList/getMyLostList', '丢失消息管理');
INSERT INTO `auth_list` VALUES ('lostMsgList.search', '丢失消息获取', '2024-09-25 22:34:20', 'lostMsgList/search', '丢失消息管理');
INSERT INTO `auth_list` VALUES ('lostMsgList.updateLost', '丢失消息修改', '2024-09-25 22:34:20', 'lostMsgList/updateLost', '丢失消息管理');
INSERT INTO `auth_list` VALUES ('task.search', '操作记录查询', '2024-09-25 22:34:20', 'task/search', '设备管理');
INSERT INTO `auth_list` VALUES ('userAmountFlow.search', '流水信息查询', '2024-09-25 22:34:20', 'userAmountFlow/search', '系统管理');
INSERT INTO `auth_list` VALUES ('wallpaper.add', '添加壁纸', '2024-09-25 22:34:20', 'wallpaper/add', '壁纸管理');
INSERT INTO `auth_list` VALUES ('wallpaper.delete', '删除壁纸', '2024-09-25 22:34:20', 'wallpaper/delete', '壁纸管理');
INSERT INTO `auth_list` VALUES ('wallpaper.search', '查询壁纸', '2024-09-25 22:34:20', 'wallpaper/search', '壁纸管理');
INSERT INTO `auth_list` VALUES ('wallpaper.update', '修改壁纸', '2024-09-25 22:34:20', 'wallpaper/update', '壁纸管理');
...
CREATE TABLE `device_access_auth_list`  (
  ...
  `auth_type` int(1) NOT NULL DEFAULT 1 COMMENT '权限类型_权限:1-配置:2',
  `auth_value` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '配置的权限值',
  PRIMARY KEY (`auth_id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `device_access_auth_list` VALUES ('1', 'allowEraseContentAndSettings', '禁止抹掉所有内容和设置', '禁止抹掉所有内容和设置', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('10', 'allowUntrustedTLSPrompt', '不允许建立不信任的tls链接', '不允许建立不信任的tls链接', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('11', 'allowFilesUSBDriveAccess', '\"文件\"APP无法访问USB驱动器', '\"文件\"APP无法访问USB驱动器', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('12', 'allowWebDistributionAppInstallation', '禁止网页分发APP', '禁止网页分发APP', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('13', 'safe_dns', '安全dns', '安全dns', 0, '无', '2024-08-28 11:26:25', 1, 1, 2, '{\"dnsUrl\": \"https://dns.alidns.com/dns-query\"}');
INSERT INTO `device_access_auth_list` VALUES ('14', 'wifi', '默认wifi', '默认wifi', 0, '无', '2024-08-28 11:26:25', 1, 1, 2, '{\"wifiName\": \"mdm.top\",\"wifiPassword\": \"123456789\"}');
INSERT INTO `device_access_auth_list` VALUES ('15', 'httpProxy', '禁用退出远程管理', '开启后用户无法退出远程管理', 0, '无', '2024-05-13 19:55:31', 1, 1, 2, '{\"pacUrl\": \"\"}');
INSERT INTO `device_access_auth_list` VALUES ('2', 'allowHostPairing', '禁止itunes连接', '禁止itunes连接', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('3', 'allowEnterpriseAppTrust', '禁止信任App', '禁止信任App', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('4', 'allowUIConfigurationProfileInstallation', '禁止安装描述文件', '禁止安装描述文件', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('5', 'forceAutomaticDateAndTime', '禁止修改时间', '禁止修改时间', 0, '<true/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('6', 'allowVPNCreation', '禁止VPN连接', '禁止修改时间', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('7', 'allowAccountModification', '禁止修改ApplelD', '禁止修改ApplelD', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('8', 'allowWallpaperModification', '禁止修改壁纸', '禁止修改壁纸', 0, '<false/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('9', 'forceEncryptedBackup', '开启加密备份', '开启加密备份', 0, '<true/>', '2024-05-13 19:55:31', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('a0621a00fcd642c6800ecda35cf0f994', 'allowFindMyDevice', '不允许开启找查我的设备', '不允许开启找查我的设备', 0, '<false/>', '2024-07-19 00:35:19', 1, 1, 1, '');
INSERT INTO `device_access_auth_list` VALUES ('a14f632253364b6ca34eab18c170c80d', 'forceWiFiPowerOn', '禁止关闭WIFI', '禁止关闭WIFI', 0, '<true/>', '2024-08-28 11:26:25', 1, 1, 1, '');
...
CREATE TABLE `device_mdm_profile`  (
  ...
  `org_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组织id',
  `disable_erase` int(1) NOT NULL COMMENT '是否开启远程管理按钮限制_是:1-否:0 字段弃用',
  PRIMARY KEY (`device_id`) USING BTREE,
...
-- ----------------------------
-- Table structure for device_token_log
-- ----------------------------
DROP TABLE IF EXISTS `device_token_log`;
CREATE TABLE `device_token_log`  (
  `log_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'logid',
  `device_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '设备ip',
  `device_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '设备token',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `device_magic` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '设备magic',
  PRIMARY KEY (`log_id`) USING BTREE,
  INDEX `device_id`(`device_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '设备token变动' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of device_token_log
-- ----------------------------
...
CREATE TABLE `role_list`  (
  `role_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '角色id_c',
  `auth_list` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '权限id列表[]_c',
  `create_time` datetime NOT NULL COMMENT '创建时间_c',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `org_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组织id_c',
  `user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户id_c',
  `is_delete` int(1) NOT NULL COMMENT '是否删除_是:1-否:0',
...
INSERT INTO `sys_settings` VALUES ('httpPac', 'https://admin.mdm.top/conf/http.pac', '1970-01-01 00:00:00', '2024-08-05 23:07:38', 'httpPac代理文件url 弃用');
...
INSERT INTO `sys_settings` VALUES ('taskNoResErrRetry', '60', '1970-01-01 00:00:00', '2024-08-23 22:14:48', '命令发送未响应重试 /秒');
...
CREATE TABLE `user`  (
  ...
  `staff_device_auth` int(1) NOT NULL DEFAULT 1 COMMENT '员工设备权限_所有:1-仅自己:0',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('addcab9ecfd741b6ae80b8bd6ff43093', '373cd7298b15a27d5aa79c4315d34fec0b8a8fbf', '2024-07-11 13:48:56', '2024-07-11 13:48:56', '2024-07-11 13:48:56', '223.242.11.245', 1, '中国|0|安徽省|六安市|电信', '252493133@qq.com', 'super', 'cc176bf53f76d8d3045ea825eae10012e5aed8df', 112, '', '', 'addcab9ecfd741b6ae80b8bd6ff43093', '170', '156', 1, 0, 1);
...
CREATE TABLE `user_api_token`  (
  `user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户id',
  `api_token` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'token',
  `create_time` datetime NOT NULL,
  `update_time` datetime NOT NULL,
  `org_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组织id',
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户apitoken\r\n' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_auth`  (
  ...
  PRIMARY KEY (`user_id`) USING BTREE,
  INDEX `org_id`(`org_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户权限列表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_notify`  (
  `nt_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '通知id',
  `user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户id',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '标题',
  `ass_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '副标题',
  ...
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `email_err` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '邮箱发送失败原因',
  `wx_err` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '微信群发送失败原因',
  `wx_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '微信群名称',
  `org_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组织id',
